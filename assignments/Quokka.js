...
let alphabeticalEmailAddresses = runners.map(function(currentValue) {
  return currentValue.email;
});

console.log(alphabeticalEmailAddresses.sort());

// Problem 2

let alphabeticalCompanyName = runners.map(function(currentValue) {
  return currentValue.company_name;
});

console.log(alphabeticalCompanyName.sort());

// Problem 3

let youngDumbAndBroke = runners.filter(function(currentValue) {
  return currentValue.donation < 100;
});

console.log(youngDumbAndBroke);
